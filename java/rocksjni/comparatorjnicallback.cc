...
BaseComparatorJniCallback::BaseComparatorJniCallback(
  ...
  jstring jsName =
      (jstring)env->CallObjectMethod(m_jcallback_obj, jNameMethodId);
...
const char* BaseComparatorJniCallback::Name() const { return m_name.get(); }
...
void BaseComparatorJniCallback::FindShortestSeparator(
  ...
  jstring jsResultStart = (jstring)env->CallObjectMethod(
      m_jcallback_obj, m_jFindShortestSeparatorMethodId, jsStart,
      m_jSliceLimit);
  ...
  if (jsResultStart != nullptr) {
    ...
    jboolean has_exception = JNI_FALSE;
    std::unique_ptr<const char[]> result_start =
        JniUtil::copyString(env, jsResultStart,
...
void BaseComparatorJniCallback::FindShortSuccessor(std::string* key) const {
  ...
  jstring jsResultKey = (jstring)env->CallObjectMethod(
      m_jcallback_obj, m_jFindShortSuccessorMethodId, jsKey);
  ...
  if (jsResultKey != nullptr) {
    ...
    jboolean has_exception = JNI_FALSE;
    std::unique_ptr<const char[]> result_key =
        JniUtil::copyString(env, jsResultKey,
