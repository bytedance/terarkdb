...
// for TERARKDB_NAMESPACE::TransactionDBOptions.
...
jbyte Java_org_rocksdb_TransactionDBOptions_getWritePolicy(JNIEnv* /*env*/,
                                                           ...
                                                           jlong jhandle) {
  auto* opts = reinterpret_cast<TERARKDB_NAMESPACE::TransactionDBOptions*>(jhandle);
  return TERARKDB_NAMESPACE::TxnDBWritePolicyJni::toJavaTxnDBWritePolicy(
      opts->write_policy);
}
...
void Java_org_rocksdb_TransactionDBOptions_setWritePolicy(JNIEnv* /*env*/,
  ...
  auto* opts = reinterpret_cast<TERARKDB_NAMESPACE::TransactionDBOptions*>(jhandle);
  opts->write_policy =
      TERARKDB_NAMESPACE::TxnDBWritePolicyJni::toCppTxnDBWritePolicy(jwrite_policy);
}
