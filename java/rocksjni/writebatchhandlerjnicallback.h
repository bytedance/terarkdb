...
class WriteBatchHandlerJniCallback : public JniCallback,
 ...
 private:
  ...
  /**
   * @return A pointer to a TERARKDB_NAMESPACE::Status or nullptr if an
   * unexpected exception occurred
   */
  std::unique_ptr<TERARKDB_NAMESPACE::Status> kv_op(
   ...
   * unexpected exception occurred
   */
  std::unique_ptr<TERARKDB_NAMESPACE::Status> k_op(
