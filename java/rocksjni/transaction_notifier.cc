...
// for TERARKDB_NAMESPACE::TransactionNotifier.
...
jlong Java_org_rocksdb_AbstractTransactionNotifier_createNewTransactionNotifier(
  ...
  auto* sptr_transaction_notifier =
      new std::shared_ptr<TERARKDB_NAMESPACE::TransactionNotifierJniCallback>(
...
void Java_org_rocksdb_AbstractTransactionNotifier_disposeInternal(
  ...
  std::shared_ptr<TERARKDB_NAMESPACE::TransactionNotifierJniCallback>* handle =
      reinterpret_cast<
          std::shared_ptr<TERARKDB_NAMESPACE::TransactionNotifierJniCallback>*>(jhandle);
  delete handle;
}
