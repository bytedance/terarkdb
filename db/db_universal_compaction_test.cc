...
class DBTestUniversalCompactionBase
 ...
 public:
  ...
  Options CurrentOptionsRep() {
    auto opt = DBTestBase::CurrentOptions();
...
TEST_P(DBTestUniversalCompactionParallel, UniversalCompactionParallel) {
  ...
  TERARKDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack("CompactionJob::Run():Start",
                                                 [&](void* /*arg*/) {
...
TEST_P(DBTestUniversalCompaction, FinalSortedRunCompactFilesConflict) {
  ...
  Options opts = CurrentOptionsRep();
