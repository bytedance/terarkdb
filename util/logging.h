...
#define ROCKS_LOG_INFO_IF_OK(s, LGR, FMT, ...)                              \
  TERARKDB_NAMESPACE::Log(                                                  \
      (s).ok() ? InfoLogLevel::INFO_LEVEL : InfoLogLevel::ERROR_LEVEL, LGR, \
      ROCKS_LOG_PREPEND_FILE_LINE(FMT), RocksLogShorterFileName(__FILE__),  \
      ##__VA_ARGS__)
