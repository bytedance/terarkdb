...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {NUMBER_DB_GET_FG,       "lavakv.number.db.get.fg"},
    {NUMBER_BLOCK_READ_FG,   "lavakv.number.block.read.fg"},
    {NUMBER_BLOCK_READ_BG,   "lavakv.number.block.read.bg"},
};
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {FG_READ_BLOCK_ALL_MICROS, "lavakv.read.block.fg.all.micros"},
    {FG_READ_BLOCK_ALL_SIZE, "lavakv.read.block.fg.all.size"},
    {FG_READ_BLOCK_ALL_COUNT, "lavakv.read.block.fg.all.count"},
    {FG_READ_BLOCK_FS_MICROS, "lavakv.read.block.fg.fs.micros"},
    {FG_READ_SST_DATA_BLOCK_MICROS, "lavakv.read.sst.data.block.fg.micros"},
    {FG_READ_SST_DATA_BLOCK_SIZE, "lavakv.read.sst.data.block.fg.size"},
    {FG_READ_SST_CACHE_DATA_BLOCK_SIZE, "lavakv.read.sst.cache.data.block.fg.size"},
    {FG_READ_BLOB_DATA_BLOCK_MICROS, "lavakv.read.blob.data.block.fg.micros"},
    {FG_READ_BLOB_DATA_BLOCK_SIZE, "lavakv.read.blob.data.block.fg.size"},
    {FG_READ_CBT_BLOCK_MICROS,"lavakv.read.cbt.block.fg.micros"},
    {FG_READ_CBT_BLOCK_SIZE, "lavakv.read.cbt.block.fg.size"},
    {FG_READ_CBT_CACHE_BLOCK_SIZE, "lavakv.read.cbt.cache.block.fg.size"},
    {BG_READ_BLOCK_ALL_MICROS, "lavakv.read.block.bg.all.micros"},
    {BG_READ_BLOCK_ALL_SIZE, "lavakv.read.block.bg.all.size"},
    {BG_READ_BLOCK_ALL_COUNT, "lavakv.read.block.bg.all.count"},
    {BG_READ_BLOCK_FS_MICROS, "lavakv.read.block.bg.fs.micros"},
    {BG_READ_SST_DATA_BLOCK_MICROS, "lavakv.read.sst.data.block.bg.micros"},
    {BG_READ_SST_DATA_BLOCK_SIZE, "lavakv.read.sst.data.block.bg.size"},
    {BG_READ_SST_CACHE_DATA_BLOCK_SIZE, "lavakv.read.sst.cache.data.block.bg.size"},
    {BG_READ_BLOB_DATA_BLOCK_MICROS, "lavakv.read.blob.data.block.bg.micros"},
    {BG_READ_BLOB_DATA_BLOCK_SIZE, "lavakv.read.blob.data.block.bg.size"},
    {BG_READ_CBT_BLOCK_MICROS,"lavakv.read.cbt.block.bg.micros"},
    {BG_READ_CBT_BLOCK_SIZE, "lavakv.read.cbt.block.bg.size"},
    {BG_READ_CBT_CACHE_BLOCK_SIZE, "lavakv.read.cbt.cache.block.bg.size"},
