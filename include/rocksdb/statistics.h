...
enum Tickers : uint32_t {
  ...
  NUMBER_DB_GET_FG,
  NUMBER_BLOCK_READ_FG,
  NUMBER_BLOCK_READ_BG,
  TICKER_ENUM_MAX
};
...
enum Histograms : uint32_t {
  ...
  FG_READ_BLOCK_ALL_MICROS,
  FG_READ_BLOCK_ALL_SIZE,
  FG_READ_BLOCK_ALL_COUNT,
  FG_READ_BLOCK_FS_MICROS,
  FG_READ_SST_DATA_BLOCK_MICROS,
  FG_READ_SST_DATA_BLOCK_SIZE,
  FG_READ_SST_CACHE_DATA_BLOCK_SIZE,
  FG_READ_BLOB_DATA_BLOCK_MICROS,
  FG_READ_BLOB_DATA_BLOCK_SIZE,
  FG_READ_CBT_BLOCK_MICROS,
  FG_READ_CBT_BLOCK_SIZE,
  FG_READ_CBT_CACHE_BLOCK_SIZE,
  BG_READ_BLOCK_ALL_MICROS,
  BG_READ_BLOCK_ALL_SIZE,
  BG_READ_BLOCK_ALL_COUNT,
  BG_READ_BLOCK_FS_MICROS,
  BG_READ_SST_DATA_BLOCK_MICROS,
  BG_READ_SST_DATA_BLOCK_SIZE,
  BG_READ_SST_CACHE_DATA_BLOCK_SIZE,
  BG_READ_BLOB_DATA_BLOCK_MICROS,
  BG_READ_BLOB_DATA_BLOCK_SIZE,
  BG_READ_CBT_BLOCK_MICROS,
  BG_READ_CBT_BLOCK_SIZE,
  BG_READ_CBT_CACHE_BLOCK_SIZE,
